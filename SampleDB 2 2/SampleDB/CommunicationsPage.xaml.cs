...
namespace SampleDB
{
   ...
   //         Frame frame = new Frame();
            ...
            //frame.Content = visibleOrInVisibleMainStack;
        ...
        public void secondPartLayoutDesign(List<JSSEMasterBehavior> listOfObjectsPerCategary, StackLayout secondStackRef, string titleLabel){
            ...
            visibleOrInvisibleStack.Padding =new Thickness(10,0,10,0);
           ...
           // StackLayout groupTitleStack = null;
            ...
            for (int i = 0; i < listOfObjectsPerCategary.Count; i++)
            {
                ...
                groupTitleStack.HorizontalOptions = LayoutOptions.Start;
               ...
               // secondPartStack.BackgroundColor = Color.Red;
                if (i == 0)
                {
                    ...
                    headingLabel.HorizontalOptions = LayoutOptions.Start;
                ...
                OverAllRatingsDesign(listOfRatings, ratingsLayout ,listOfObjectsPerCategary[i].Category_ID);
